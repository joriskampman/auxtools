...
This _auxtools_ module contains a large set of smaller and medium-sized python functions which can come in handy when working in python. They are _auxiliary_ tools, hence the name `auxtools`.
